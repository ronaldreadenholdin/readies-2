...
class CashForoOpenBankingAdaptor extends AbstractPspAdaptor
{
    ...
    public function createPayment(PspPaymentRequest $request): PspPaymentResponse
    {
        ...
        // TODO: replace path and response mapping when CashForo API docs are supplied.
        return new PspPaymentResponse(
            ...
            failureMessage: 'CashForo Open Banking payment-initiation path and response mapping are not documented yet.'
        );
    }
    ...
    public function getPaymentStatus(string $providerReference): PspPaymentResponse
    {
        return new PspPaymentResponse(
            ...
            failureCode: 'API_DOCS_REQUIRED',
            failureMessage: 'CashForo Open Banking status endpoint is not documented yet.'
        );
    }
    ...
    public function refund(PspRefundRequest $request): PspRefundResponse
    {
        return new PspRefundResponse(
            ...
            failureCode: 'API_DOCS_REQUIRED',
            failureMessage: 'CashForo Open Banking refund/reversal endpoint is not documented yet.'
        );
    }
