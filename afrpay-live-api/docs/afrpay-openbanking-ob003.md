# AfrPay Open Banking adaptor - OB003
...
## Required AfrPay API details

These are still needed from AfrPay before live mapping:
...
Readies should normalize AfrPay Open Banking statuses into:
