...
The exact AfrPay endpoint paths, auth requirements, response fields, webhook event names, and signature canonical string still require AfrPay's official API documentation before live mapping can be completed.
