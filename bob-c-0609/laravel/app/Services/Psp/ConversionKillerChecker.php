    ...
    public function checkNormalizedOutput(string $pspCode, string $connection, array $normalized, ?array $golden = null): array
    {
        ...
        $results = [
            ...
            $this->result(
                ...
                'App\Services\Psp\Converters\FblsP003Converter::normalizeCreatePaymentResponse',
                'blocks cascade',
            ...
            $this->result(
                ...
                'App\Services\Psp\Converters\FblsP003Converter::mapStatus',
                'blocks cascade',
            ...
            $this->result(
                ...
                'App\Services\Psp\Converters\FblsP003Converter::declineFor',
                'blocks cascade',
